        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
          ...
          {isLoggedIn ? (
            <form action={logout} className="sm:shrink-0">
              <button
                type="submit"
                className="w-full rounded-full border border-amber-200/25 bg-amber-100/10 px-4 py-2 text-sm font-semibold text-amber-100 transition hover:bg-amber-200/20 hover:text-white sm:w-auto"
              >
                ログアウト
              </button>
            </form>
          ) : (
            <div className="flex flex-wrap items-center gap-3 text-sm font-semibold sm:flex-nowrap">
              <Link
                href="/login"
